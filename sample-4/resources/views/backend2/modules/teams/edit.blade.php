...
<div class="wrapper-shadow-inset">
  ...
  <form class="form-edit-category" name="addCategory" role="form" method="post" id="categoryForm" enctype="multipart/form-data">
   @csrf
                            ...
                            <div class="col-md-8">
                              <div class="row"> 
                                ...
                                <div class="col-sm-12" id="socialItemContainer">
                                  ...
                                  <?php $social_medias = json_decode($data->social_medias); $no = 0; ?>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-8">
                                      <input type="text" name="urls[]" class="form-control" value="{{$value}}" placeholder="Enter url">
                                    </div>
                                    <div class="col-1">
                                      @if($no == 0)
