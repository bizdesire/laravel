...
.table-loader img{
  ...
  <body data-loader="{{url('/loading.gif')}}" class="theme-{{Auth::user()->theme_mode ?? 'light'}}">
    ...
    <div class="page-wrapper d-flex flex-wrap">
      ...
      <div class="settings-sidebar">
        ...
        <h4>Notifications</h4>
        <a href="javascript:void(0);" class="shadow-icon"><span class="material-icons">close</span></a>
      </div>
