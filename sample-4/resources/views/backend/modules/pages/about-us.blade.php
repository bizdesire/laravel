                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 ">
                                        <div class="form-group">
                                            ...
                                            <textarea name="ourHistory" class="form-control editor" required><?= $content->ourHistory ?? '' ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Value</label>
                                                    <input type="text" name="projectDetailValueFirst"
                                                        value="{{ $content->projectDetailValueFirst ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="projectDetailTitleFirst"
                                                        value="{{ $content->projectDetailTitleFirst ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Value</label>
                                                    <input type="text" name="projectDetailValueSecond"
                                                        value="{{ $content->projectDetailValueSecond ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="projectDetailTitleSecond"
                                                        value="{{ $content->projectDetailTitleSecond ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Value</label>
                                                    <input type="text" name="projectDetailValueThird"
                                                        value="{{ $content->projectDetailValueThird ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="projectDetailTitleThird"
                                                        value="{{ $content->projectDetailTitleThird ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 ">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="visionHeadingTitle"
                                                value="{{ $content->visionHeadingTitle ?? '' }}" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 ">
                                        <div class="form-group">
                                            <label>Tagline</label>
                                            <input type="text" name="visionHeadingTagline"
                                                value="{{ $content->visionHeadingTagline ?? '' }}" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="joinHeadingTitle"
                                                value="{{ $content->joinHeadingTitle ?? '' }}" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 ">
                                        <div class="form-group">
                                            <label>Tagline</label>
                                            <input type="text" name="joinHeadingTagline"
                                                value="{{ $content->joinHeadingTagline ?? '' }}" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="joinSectionOneTitle"
                                                        value="{{ $content->joinSectionOneTitle ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="joinSectionTwoTitle"
                                                        value="{{ $content->joinSectionTwoTitle ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="joinSectionThreeTitle"
                                                        value="{{ $content->joinSectionThreeTitle ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" name="joinSectionFourTitle"
                                                        value="{{ $content->joinSectionFourTitle ?? '' }}"
                                                        class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="ourTeamTitle"
                                                value="{{ $content->ourTeamTitle ?? '' }}" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 ">
                                        <div class="form-group">
                                            <label>Tagline</label>
                                            <input type="text" name="ourTeamTagline"
                                                value="{{ $content->ourTeamTagline ?? '' }}" class="form-control"
                                                required>
                                        </div>
                                    </div>
