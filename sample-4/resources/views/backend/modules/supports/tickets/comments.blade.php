                ...
                <div class="col-12">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                          ...
                          <h6>Category : <span class="badge badge-primary">{{$data->category->label}}</span></h6>
                          <h6>Status : <span class="badge badge-warning">{{$data->getStatus()}}</span></h6>
                          <p class="card-text">{{$data->message}}</p> 
                      <div class="col-12 text-right">   <?= $data->getChangeStatusBtn() ?></div>

                          <livewire:admin.ticket-comment :data="$data"/>
