...
function upload_form_file_with_ckeditor($this) {
  ...
  $("body").on('change','.pictureUpload', function(e) { 
    var file = e.target.files[0];
    var reader = new FileReader();
$this = $(this);
    reader.onload = function(e) {
      $this.closest('.form-group').find('.previewImage').html('<img src="' + e.target.result + '" alt="Uploaded Image" style="width:'+$this.data('width')+'px">');
    };
